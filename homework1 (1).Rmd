...
```{r ans11}
# NBA1920Final567
Game5<-list(Date="Oct.9",StartTime="21:00",TimeZone="ET",Away="Miami Heat",Home="L.A. Lakers")
Game6<-list(Date="Oct.11",StartTime="19:30",TimeZone="ET",Away="L.A. Lakers",Home="Miami Heat")
Game7<-list(Date="Oct.13",StartTime="21:00",TimeZone="ET",Away="Miami Heat",Home="L.A. Lakers")
...
chNumbersWith0 <- sample(b, randomLength, replace=T)
```
...
ytoten<-as.character(1:9)

as.integer(ytoten)->ch1to9

sum(chNumbers)->sumChNumbers
sumChNumbers
...
```{r ans22}
# sumChNumbersWith0
a0toten<-as.character(0:9)
a0toten->ch0to9
  as.integer(ch0to9)->b
sum(chNumbersWith0 )->sumChNumbersWith0
sumChNumbersWith0
```
